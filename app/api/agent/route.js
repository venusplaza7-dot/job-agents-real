...
<div style="margin:16px 0;display:flex;gap:10px">
  ...
  <a href="https://job-agents-real.vercel.app" style="border:1px solid #0f172a;padding:10px 16px;border-radius:6px;text-decoration:none;color:#0f172a">🤖 Live Demo</a>
</div>
<p>15-min call this week? Built in Lahore (GMT+5) - available your morning.</p>
<p>Best,<br/><b>Ron Kahn</b><br/>AI Developer / Full-Stack Engineer</p>
<div style="border:1px solid #e2e8f0;border-radius:8px;padding:12px;margin-top:16px">
